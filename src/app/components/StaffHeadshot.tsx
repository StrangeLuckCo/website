    ...
    <div className="max-w-4xl">
      <div className="flex flex-col items-center sm:items-start gap-y-3">
        <div className="flex flex-col sm:flex-row text-4xl sm:text-5xl leading-none gap-3 items-center">
          <h2 className="sl-h2 sl-h2-mobile blur-xs sm:blur-md">{name}</h2>
          <span className="hidden sm:block sl-h2"> | </span>
          {/* <h3 className="sm:hidden text-3xl mb-4">{name}</h3> */}
          <h2 className="sl-h2 sl-h3-mobile blur-xs sm:blur-md">{title}</h2>
        </div>
        <div className="flex flex-col sm:flex-row gap-y-4 sm:gap-y-0 gap-x-4 items-center">
          ...
          <div className="flex flex-col gap-y-4 px-8 sm:px-0 text-2xl leading-none">
            <h4 className="sl-h4 sl-h4-mobile blur-xs">{credits}</h4>
            <p className="text-xs sl-p sl-p-mobile font-normal leading-none blur-xxs">
              {bio}
            </p>
          </div>
        </div>
